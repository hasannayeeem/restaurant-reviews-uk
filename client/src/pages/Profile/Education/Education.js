...
const Education = () => {
    ...
    return (
        <section>
            <h1 className='text-center text-white text-3xl py-3 font-bold border-b-2 border-b-gray-300'>Education</h1>
            <div>
                {
                    toogleEducationEdit ?
                        ...
                        <form onSubmit={handleSubmit(handleUpdateEducation)}>
                            <div className='grid grid-cols-1 lg:grid-cols-2 gap-x-5 gap-y-2 p-4'>
                                <div>
                                    <label className='font-medium text-white'>Edit Education Level</label>
                        ...
                        <div className='grid grid-cols-1 text-white m-5 space-y-3'>
